...
public:
    ...
    */
  virtual bool sendInvitation(const QString &accountId, const QString &notebookUid, const KCalCore::Incidence::Ptr &invitation, const QString &body) =0;
    ...
    /** \brief Send a updated invitation to all the participants.
        ...
        @return True if OK, false otherwise.
    */
  virtual bool sendUpdate(const QString &accountId, const KCalCore::Incidence::Ptr &invitation, const QString &body) = 0;
    ...
    /** \brief Send the updated invitation back to the Organiser.
        ...
        @return True if OK, false otherwise.
      */
  virtual bool sendResponse(const QString &accountId, const KCalCore::Incidence::Ptr &invitation, const QString &body) = 0;
